...
@Component
public class DeliveryAddressResponseMapperImpl implements DeliveryAddressResponseMapper {

    @Override
    public DeliveryAddressResponse entityToProtocol(AddDeliveryAddressDao entity) {
        if ( entity == null ) {
            return null;
        }
    ...
    @Override
    public AddDeliveryAddressDao protocolToEntity(DeliveryAddressResponse schema) {
        if ( schema == null ) {
            return null;
        }
        ...
        gps = schema.getGps();
        defaultAddress = schema.getDefaultAddress();
        address = schema.getAddress();

        AddDeliveryAddressDao addDeliveryAddressDao = new AddDeliveryAddressDao( context, userId, error, id, descriptor, gps, defaultAddress, address );

        return addDeliveryAddressDao;
    }
