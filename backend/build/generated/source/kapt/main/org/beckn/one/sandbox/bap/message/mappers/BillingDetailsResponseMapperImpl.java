...
@Component
public class BillingDetailsResponseMapperImpl implements BillingDetailsResponseMapper {

    @Override
    public BillingDetailsResponse entityToProtocol(BillingDetailsDao entity) {
        if ( entity == null ) {
            return null;
        }
    ...
    @Override
    public BillingDetailsDao protocolToEntity(BillingDetailsResponse schema) {
        if ( schema == null ) {
            return null;
        }
