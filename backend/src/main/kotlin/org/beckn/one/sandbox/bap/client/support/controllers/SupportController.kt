...
class SupportController @Autowired constructor(
  ...
  fun getSupportV1(
    ...
    val context =
      getContext(supportRequest.context.transactionId, supportRequest.context.bppId, supportRequest.context.bppUri) // might not matter as the context might have different transaction id
